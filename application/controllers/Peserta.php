...
class Peserta extends CI_Controller
{
	...
	public function validasi_peserta($method)
	{
		...
		$this->form_validation->set_rules('klsp', 'KLSP', 'required');
	...
	public function save()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$input = [
				...
				'skema_id' 		=> $this->input->post('skema', true),
			];
			if ($method === 'add') {
				$action = $this->master->create('peserta', $input);
			} else if ($method === 'edit') {
				$id = $this->input->post('id_mahasiswa', true);
				$action = $this->master->update('peserta', $input, 'id_mahasiswa', $id);
			}
	...
	public function delete()
	{
		...
		if (!$chk) {
			...
			if ($this->master->delete('peserta', $chk, 'id_mahasiswa')) {
