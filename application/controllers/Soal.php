...
class Soal extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->ion_auth->is_admin()) {
            ...
            $data['skemalsp'] = $this->soal->getskemalspPengajar($user->username);
        }
    ...
    public function add()
    {
        ...
        if ($this->ion_auth->is_admin()) {
            //Jika admin maka tampilkan semua skemalsp
            $data['pengajar'] = $this->soal->getAllpengajar();
        } else {
            //Jika bukan maka skemalsp dipilih otomatis sesuai skemalsp dosen
            $data['pengajar'] = $this->soal->getskemalspPengajar($user->username);
        }
