        ...
        <div class="row">
            <div class="col-sm-12 mb-4">
                ...
                <div class="pull-right">
                    <a target="_blank" href="<?= base_url() ?>hasilujianessay/cetak_detail/<?= $this->uri->segment(3) ?>" class="btn bg-maroon btn-flat btn-sm">
            ...
            <div class="col-sm-6">
                <table class="table w-100">
                    ...
                    <tr>
                        <th>Tanggal Mulai</th>
                        <td><?= strftime('%A, %d %B %Y', strtotime($ujianessay->tgl_mulai)) ?></td>
                    </tr>
                    <tr>
                        <th>Tanggal Selasi</th>
                        <td><?= strftime('%A, %d %B %Y', strtotime($ujianessay->terlambat)) ?></td>
                    </tr>
                </table>
            </div>
            <div class="col-sm-6">
