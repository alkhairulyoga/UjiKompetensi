<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?= form_open('ujian_essay/save', array('id' => 'formujian_essay'), array('method' => 'add', 'pengajar_id' => $dosen->id_pengajar, 'klsp_id' => $skemalsp->klsp_id)) ?>
                <div class="form-group">
                    <label for="nama_essay">Nama Ujian</label>
                    <input autofocus="autofocus" onfocus="this.select()" placeholder="Nama Ujian" type="text" class="form-control" name="nama_essay">
...
<script src="<?= base_url() ?>assets/dist/js/app/ujian_essay/add.js"></script>