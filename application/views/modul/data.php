		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="pull-right">
					<a href="<?= base_url('modul/add') ?>" class="btn bg-purple btn-flat btn-sm"><i class="fa fa-plus"></i> Buat modul</a>
					<button type="button" onclick="reload_ajax()" class="btn btn-flat btn-sm bg-maroon"><i class="fa fa-refresh"></i> Reload</button>
				</div>
			</div>
		</div>
	</div>
	<?= form_open('modul/delete', array('id' => 'bulk')) ?>
	<div class="table-responsive px-4 pb-3" style="border: 0">
		<table id="modul" class="w-100 table table-striped table-bordered table-hover">
			<thead>
				<tr>
...
<script src="<?= base_url() ?>assets/dist/js/app/modul/data.js"></script>
