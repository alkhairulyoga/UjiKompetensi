...
if (time() >= $soal->waktu_habis) {
    redirect('latihanmodul/list', 'location', 301);
}
?>
<div class="row">
    <div class="col-sm-3">
    ...
    <div class="col-sm-9">
        <?= form_open('', array('id' => 'latihanmodul'), array('id' => $id_tes)); ?>
        <div class="box box-primary">
            <div class="box-header with-border">
...
<script src="<?= base_url() ?>assets/dist/js/app/latihanmodul/sheet.js"></script>