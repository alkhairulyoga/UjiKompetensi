<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?= form_open('latihanmodul/save', array('id' => 'formlatihanmodul'), array('method' => 'add', 'pengajar_id' => $dosen->id_pengajar, 'klsp_id' => $skemalsp->klsp_id)) ?>
                <div class="form-group">
                    <label for="nama_latihan">Nama latihanmodul</label>
                    <input autofocus="autofocus" onfocus="this.select()" placeholder="Nama latihanmodul" type="text" class="form-control" name="nama_latihan">
...
<script src="<?= base_url() ?>assets/dist/js/app/latihanmodul/add.js"></script>