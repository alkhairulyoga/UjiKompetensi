<div class="row">
    ...
    <div class="col-xxl-3 col-md-6">
        <div class="card info-card sales-card">
            <div class="card-body">
                <h5 class="card-title">latihanmodul <span>| Today</span></h5>
                        ...
                        <div class="box">
                            <div class="card">
                                ...
                                <div class="table-responsive px-4 pb-3" style="border: 0">
                                    <table id="latihanmodul" class="table">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Nama Latihan</th>
    ...
    <script src="<?= base_url() ?>assets/dist/js/app/latihanmodul/list.js"></script>