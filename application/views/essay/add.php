<div class="row">
    <div class="col-sm-12">
        <?= form_open_multipart('essay/save', array('id' => 'formessay'), array('method' => 'add')); ?>
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="col-sm-12">
                            <label for="essay" class="control-label">Soal Essay</label>
                            <div class="form-group">
                                <input type="file" name="file_essay" class="form-control">
                                <small class="help-block" style="color: #dc3545"><?= form_error('file_essay') ?></small>
                            </div>
                            <div class="form-group">
