<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data Skema LSP, hanya bisa diisi menggunakan ID Skema LSP. <a data-toggle="modal" href="#skemalspId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="<?= $data['skemalsp_id'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['skemalsp_id'] == null ? 'BELUM DIISI' : $data['skemalsp_id'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                    if ($data['nip'] == null || $data['nama_dosen'] == null || $data['email'] == null || $data['skemalsp_id'] == null) {
                                        $status = false;
                                    }
                                endforeach;
                            }
...
<div class="modal fade" id="skemalspId">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Data Skema LSP</h4>
            </div>
            <div class="modal-body">
                <table id="skemalsp" class="table table-condensed table-striped">
                    <thead>
                        <th>ID</th>
                        <th>Skema LSP</th>
                    </thead>
