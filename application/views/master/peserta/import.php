<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data Skema, hanya bisa diisi menggunakan ID Skema. <a data-toggle="modal" href="#skemaId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="<?= $data['skema_id'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['skema_id'] == null ? 'BELUM DIISI' : $data['skema_id'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                    if ($data['nim'] == null || $data['nama'] == null || $data['email'] == null || $data['jenis_kelamin'] == null || $data['skema_id'] == null) {
                                        $status = false;
                                    }
                                endforeach;
                            }
...
<div class="modal fade" id="skemaId">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Data Skema</h4>
            </div>
            <div class="modal-body">
                <table id="skema" class="table table-bordered table-condensed table-striped">
                    <thead>
                        <th>ID</th>
                        <th>Skema</th>
                        <th>Level</th>
