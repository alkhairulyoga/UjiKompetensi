<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data jurusan, hanya bisa diisi menggunakan ID Level. <a data-toggle="modal" href="#jurusanId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/skema.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
            <?= form_open_multipart('skema/preview'); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td class="<?= $data['skema'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['skema'] == null ? 'BELUM DIISI' : $data['skema']; ?>
                                        </td>
                            ...
                            <?php
                                    if ($data['skema'] == null || $data['jurusan'] == null) {
                                        $status = false;
                                    }
                                endforeach;
                            }
                    ...
                    <?php if ($status) : ?>
                        ...
                        <?= form_open('skema/do_import', null, ['data' => json_encode($import)]); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Data Level</h4>
            </div>
