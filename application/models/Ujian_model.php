...
class Ujian_model extends CI_Model
{
    ...
    {
        $this->datatables->select('a.id_ujian, a.token, a.nama_ujian, b.nama_klsp, a.jumlah_soal, CONCAT(a.tgl_mulai, " <br/> (", a.waktu, " Menit)") as waktu, a.jenis');
    ...
    public function getSoal($id)
    {
        ...
        $this->db->where('klsp_id', $ujian->klsp_id);
