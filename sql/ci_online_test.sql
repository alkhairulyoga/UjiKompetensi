...
INSERT INTO `dosen` (`id_dosen`, `nip`, `nama_dosen`, `email`, `skemalsp_id`) VALUES
...
--
-- Table structure for table `level_skemalsp`
--

CREATE TABLE `level_skemalsp` (
  `id` int(11) NOT NULL,
  `skemalsp_id` int(11) NOT NULL,
...
--
-- Dumping data for table `level_skemalsp`
--

INSERT INTO `level_skemalsp` (`id`, `skemalsp_id`, `jurusan_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 2),
(6, 5, 2);
...
INSERT INTO `skema` (`id_skema`, `nama_skema`, `jurusan_id`) VALUES
(1, '12.1E.13', 1),
(2, '11.1A.13', 1),
(3, '10.1D.13', 1),
(7, '12.1A.10', 2),
...
--
-- Table structure for table `skema_pengajar`
--

CREATE TABLE `skema_pengajar` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `skema_pengajar`
--

INSERT INTO `skema_pengajar` (`id`, `skema_id`, `dosen_id`) VALUES
(1, 3, 1),
(2, 2, 1),
(3, 1, 1),
(9, 2, 3),
...
CREATE TABLE `mahasiswa` (
  ...
  `skema_id` int(11) NOT NULL COMMENT 'skema&jurusan'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `mahasiswa` (`id_mahasiswa`, `nama`, `nim`, `email`, `jenis_kelamin`, `skema_id`) VALUES
(1, 'Muhammad Ghifari Arfananda', '12183018', 'mghifariarfan@gmail.com', 'L', 1);

-- --------------------------------------------------------

--
-- Table structure for table `skemalsp`
--

CREATE TABLE `skemalsp` (
  `id_skemalsp` int(11) NOT NULL,
  `nama_skemalsp` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `skemalsp`
--

INSERT INTO `skemalsp` (`id_skemalsp`, `nama_skemalsp`) VALUES
(1, 'Bahasa Inggris'),
(2, 'Dasar Pemrograman'),
(3, 'Enterpreneurship'),
...
INSERT INTO `m_ujian` (`id_ujian`, `dosen_id`, `skemalsp_id`, `nama_ujian`, `jumlah_soal`, `waktu`, `jenis`, `tgl_mulai`, `terlambat`, `token`) VALUES
...
INSERT INTO `tb_soal` (`id_soal`, `dosen_id`, `skemalsp_id`, `bobot`, `file`, `tipe_file`, `soal`, `opsi_a`, `opsi_b`, `opsi_c`, `opsi_d`, `opsi_e`, `file_a`, `file_b`, `file_c`, `file_d`, `file_e`, `jawaban`, `created_on`, `updated_on`) VALUES
...
ALTER TABLE `dosen`
  ...
  ADD KEY `skemalsp_id` (`skemalsp_id`);
...
--
-- Indexes for table `level_skemalsp`
--
ALTER TABLE `level_skemalsp`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `skema_pengajar`
--
ALTER TABLE `skema_pengajar`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `skemalsp`
--
ALTER TABLE `skemalsp`
  ADD PRIMARY KEY (`id_skemalsp`);
...
--
-- AUTO_INCREMENT for table `level_skemalsp`
--
ALTER TABLE `level_skemalsp`
...
--
-- AUTO_INCREMENT for table `skema_pengajar`
--
ALTER TABLE `skema_pengajar`
...
--
-- AUTO_INCREMENT for table `skemalsp`
--
ALTER TABLE `skemalsp`
  MODIFY `id_skemalsp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `dosen`
  ADD CONSTRAINT `dosen_ibfk_1` FOREIGN KEY (`skemalsp_id`) REFERENCES `skemalsp` (`id_skemalsp`);
...
--
-- Constraints for table `level_skemalsp`
--
ALTER TABLE `level_skemalsp`
  ADD CONSTRAINT `level_skemalsp_ibfk_1` FOREIGN KEY (`jurusan_id`) REFERENCES `jurusan` (`id_jurusan`),
  ADD CONSTRAINT `level_skemalsp_ibfk_2` FOREIGN KEY (`skemalsp_id`) REFERENCES `skemalsp` (`id_skemalsp`);

--
-- Constraints for table `skema_pengajar`
--
ALTER TABLE `skema_pengajar`
  ADD CONSTRAINT `skema_pengajar_ibfk_1` FOREIGN KEY (`dosen_id`) REFERENCES `dosen` (`id_dosen`),
  ADD CONSTRAINT `skema_pengajar_ibfk_2` FOREIGN KEY (`skema_id`) REFERENCES `skema` (`id_skema`);

--
-- Constraints for table `mahasiswa`
--
ALTER TABLE `mahasiswa`
  ADD CONSTRAINT `mahasiswa_ibfk_2` FOREIGN KEY (`skema_id`) REFERENCES `skema` (`id_skema`);
...
ALTER TABLE `m_ujian`
  ...
  ADD CONSTRAINT `m_ujian_ibfk_2` FOREIGN KEY (`skemalsp_id`) REFERENCES `skemalsp` (`id_skemalsp`);

--
-- Constraints for table `tb_soal`
--
ALTER TABLE `tb_soal`
  ADD CONSTRAINT `tb_soal_ibfk_1` FOREIGN KEY (`skemalsp_id`) REFERENCES `skemalsp` (`id_skemalsp`),
